    ...
    <>
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]" >
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-violet-800 mx-2 rounded-full hover:bg-violet-950 disabled:bg-red-700 p-2 py-1 text-sm font-bold text-white  '>Add</button>
        </div>
        </div>
        ...
        <div className="todos">
          {todos.length === 0 && <div className='m-5'>No toods to show </div>}
          {todos.map(item =>{
